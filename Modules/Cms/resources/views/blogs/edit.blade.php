...
@section('content')
    <div class="mb-6">
        ...
        <p class="text-gray-600">Edit Blog</p>
    </div>
    ...
    <div class="container">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('admin.blogs.update', $blog) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="content-{{ $locale }}" class="language-content {{ $locale == app()->getLocale() ? 'block' : 'hidden' }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                ...
                                id="title_{{ $locale }}"
                                name="title[{{ $locale }}]"
                                value="{{ old('title.'.$locale, $blog->getTranslation('title', $locale, false) ?? '') }}"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea
                                ...
                                {{ $locale == app()->getFallbackLocale() ? 'required' : '' }}
                            >{{ old('content.'.$locale, $blog->getTranslation('content', $locale, false) ?? '') }}</textarea>
                        ...
                        <div class="mb-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    value="{{ old('seo.'.$locale.'.title', ($blog->seo && $blog->seo->hasTranslation('title', $locale)) ? $blog->seo->getTranslation('title', $locale) : '') }}"
                            ...
                            <div class="mb-4">
                                ...
                                >{{ old('seo.'.$locale.'.description', ($blog->seo && $blog->seo->hasTranslation('description', $locale)) ? $blog->seo->getTranslation('description', $locale) : '') }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    value="{{ old('seo.'.$locale.'.keywords', ($blog->seo && $blog->seo->hasTranslation('keywords', $locale)) ? $blog->seo->getTranslation('keywords', $locale) : '') }}"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div class="mb-6">
                    <label for="outsource_url" class="block text-sm font-medium text-gray-700 mb-2">Outsource Url</label>
                    <input
                        type="text"
                        id="outsource_url"
                        name="outsource_url"
                        value="{{ old('outsource_url', $blog->outsource_url ?? '') }}"
                ...
                <div class="mb-6">
                    ...
                    @if($blog->image)
                        <div class="mb-2">
                            <img src="{{ Storage::url($blog->image) }}" alt="Current Image" class="h-32 w-auto rounded">
