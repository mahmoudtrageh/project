                            ...
                            <tr class="table-row hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <img class="h-10 w-10 rounded-lg object-cover" src="{{ Storage::url($project->image) }}"
                                            alt="{{ $project->title }}">
                                        <div class="ms-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="px-3 py-1 inline-flex items-center text-xs leading-5 font-semibold rounded-full transition-colors duration-200
                                        ...
                                        <span
                                            class="w-1.5 h-1.5 rounded-full {{ $project->status === 'published' ? 'bg-green-600' : 'bg-yellow-600' }} mr-1.5"></span>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($project->is_featured)
                                        <span
                                            class="px-3 py-1 inline-flex items-center text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800 ring-1 ring-blue-600/20 transition-colors duration-200">
