...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-semibold text-gray-800">Hotel Reports</h1>
    <p class="text-gray-600">Track hotel performance and payments</p>
</div>
...
<div class="bg-white rounded-lg shadow mb-6">
    ...
    <div class="p-6">
        <form action="{{ route('reports.hotels') }}" method="GET" class="space-y-4">
            ...
            <div class="flex justify-between">
                ...
                <a href="{{ route('reports.export', ['type' => 'hotels'] + request()->all()) }}" 
...
<div class="bg-white rounded-lg shadow">
    <div class="px-6 py-4 border-b border-gray-200">
        <h2 class="text-lg font-semibold text-gray-800">Hotel Performance</h2>
    </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                {{ $result['summary']['total_nights'] }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                ${{ number_format($result['summary']['total_revenue'], 2) }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @php
                                    $paymentPercentage = $result['summary']['total_revenue'] > 0 ? 
                                        (($result['summary']['paid_amount'] / $result['summary']['total_revenue']) * 100) : 100;
                                @endphp
                                ...
                                <div class="text-xs text-gray-500 mt-1">
                                    {{ number_format($paymentPercentage, 0) }}% paid
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-blue-600">
                                <a href="{{ route('bookings.index', ['hotel_id' => $result['hotel']->id]) }}">
                                    View Bookings
                                </a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-4 text-center text-gray-500">
                                No hotel data found for the selected period.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
