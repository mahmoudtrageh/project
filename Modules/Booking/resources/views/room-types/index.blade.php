...
@section('content')
  <div class="flex items-center justify-between gap-5 flex-wrap">
    <div class="mb-6">
        ...
        <p class="text-gray-600">Manage room types for your hotels</p>
    </div>
        ...
        <div class="p-6 border-b border-gray-100 flex justify-between items-center">
            ...
            <div class="flex items-center gap-x-6">
                ...
                <div class="relative w-full sm:w-48">
                    <form action="{{ route('room-types.index') }}" method="GET">
                        <input type="text" name="search" placeholder="Search room types..."
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-500">
                                        {{ Str::limit($roomType->description, 50) ?? 'No description' }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ $roomType->bookings_count ?? 0 }} bookings
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    ...
                                    <button type="button" 
                                            onclick="openDeleteModal('{{ route('room-types.destroy', $roomType) }}')"
