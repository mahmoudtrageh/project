...
@section('content')
    <div class="mb-6">
        ...
        <p class="text-gray-600">Create New User</p>
    </div>
    ...
    <div class="container">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('admins.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="marketer" {{ old('user_type') == 'marketer' ? 'selected' : '' }}>Marketer</option>
                                <option value="hotel_manager" {{ old('user_type') == 'hotel_manager' ? 'selected' : '' }}>Hotel Manager</option>
                ...
                <div id="marketerFields" class="mb-6 hidden">
